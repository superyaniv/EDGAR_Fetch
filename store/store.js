...
//ITERATE THROUGH DIRECTORY OF HEADERS TO PARSE AND STORE (SYNCRONOUSLY)
	//Example Usage: 
let options_master ={'filedir_from':'./files/master/','filedir_to':'./files/master/json/'}
let options_company ={'filedir_from':'./files/companies/','filedir_to':'./files/companies/json/'}
let options_form ={'filedir_from':'./files/forms/','filedir_to':'./files/forms/json/'}
store_indexes(options_form,(op_results)=>{
